...
htmlwidgets::saveWidget(
  widget = fig, Landings_By_Type_Plotly,
  file = "Landings_By_Type_Plotly.html", "Cloud/project.html",
  selfcontained = TRUE
...
>>>>>>> 761565e399ccf9d85d6ca753eff07d45090c69dd
```
...
```{r US-commercial-economy-map, fig.alt= "The facet maps of the US represents the monitary value of Pacific Cod in relation to latitude/longitude and year. The title is "Monetary Value of Pacific Cod Landings by Relevant States", with "Longitude" on the X-axis and "Latitude" on the Y-axis. The years displayed are 1950, 1980, 1999, 2008, 2018, and 2021. The states displayed are Oregon, Washington, California, and Alaska. Overall monitary benifits from Cod landings increase over time until 2008; there was a spike and then decline. New Jersey gains the most monitary value from cod landings compared to other states."}
