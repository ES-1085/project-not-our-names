...
cod_landings_commercial_total %>%
 ...
 geom_sf_label(aes(label = State), label.size = 0.1,  nudge_x = 7, label.padding = unit(.1, "lines"),
  label.r = unit(0.15, "lines"))+
 facet_wrap(. ~ Year)+
  labs(title = " Monetary Valus of Atlantic Cod Landings by Relative States", 
...
cod_landings_commercial_total %>%
 ...
 geom_sf_label(aes(label = State), label.size = 0.1, label.padding = unit(.1, "lines"),
  label.r = unit(0.15, "lines"))+
 facet_wrap(. ~ Year)+
  labs(title = " Monetary Valus of Pacific Cod Landings by Relative States", 
       subtitle = "From 1950 to 2021, in Millions of Dollars",
       fill= "Profit (Millions)",
       x = "Longitude", 
       y = "Latitude")
