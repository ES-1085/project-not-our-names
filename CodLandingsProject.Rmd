...
```{r Commercial-Recreational, fig.alt = "Scatterplot visualises the commercial and recreational cod landings overtime. The title of the graph is "Present and Missing Recreational and Commercial Cod Landing in the U.S. from 1950 to 2021" with the "Years" on the x-axis and "Millionns of Pounds" in the y-axis. There is missing data points in the  recreational cod landings around 1990 to 2021." }
  ...
  labs(title = "Present AND Missing Recreational and Commercial Cod Landings",
       subtitle = "In the U.S. from 1950 to 2021", 
       x = "Year", 
...
cod_landings %>%
 ...
 # scale_color_viridis_d(option = "C")+
  labs(title = "Missing Cod Landing Values",
       subtitle = "In the U.S. from 1950 to 2021", 
       x = "Year",
       y = "Millions of Pounds", 
       color = "Missing Variables" )
```

##Question 1 a)
How do the total weights of recorded Atlantic and Pacific Cod landings compare to one another between the years 1950 and 2021?
...
# cod_landings_total %>%
#   mutate( image = case_when( Year %in% c(1950:2021) ~ cod_image,
#                       TRUE ~ cod_image)) 
```
...
##Question 2
How does the monetary value of  commercial Atlantic and Pacific cod landings in 1950, 1980, 1999, 2008, 2018, and 2021 varied in relative states?
...
cod_landings_commercial_total %>%
  ...
  filter( State %in% c("maine", "virginia", "connecticut", "delaware", "maryland", 
                       "massachusetts", "new hampshire", "new jersey", "new york", 
                       "north carolina", "rhode island")) %>%
  ggplot() +
  geom_sf(aes(fill = Commercial_Profit/1000000))+
 geom_sf_label(aes(label = State), label.size = 0.1,  nudge_x = 5, 
               label.padding = unit(.1, "lines"), label.r = unit(0.15, "lines"))+
 facet_wrap(. ~ Year)+
