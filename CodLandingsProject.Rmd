...
```{r US-commercial-economy-map, fig.alt= "The facet maps of the US represents the monitary value of Atlantic Cod in relation to latitude/longitude and year. The title is "Monetary Value of Atlantic Cod Landings by Relevant States", with "Longitude" on the X-axis and "Latitude" on the Y-axis. The years displayed are 1950, 1980, 1999, 2008, 2018, and 2021. The states displayed are Maine, Conneticut, Delaware, Maryland, Massachusetts, New Hampshire, New Jersey, New York, North Carolina, and Rhode Island. Overall monitary benifits from Cod landings relativily stagnet over time until 2008; there was a drastic decline. Massachusetts gains the most monitary value from cod landings compared to other states."} 
